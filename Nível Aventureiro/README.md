...
Este projeto é um simulador de movimentação de peças de xadrez desenvolvido em Linguagem C. O objetivo é exercitar a lógica de programação utilizando diferentes estruturas de repetição (for, while, do-while) e o conceito de loops aninhados.
